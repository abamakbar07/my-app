       ...
       {loading ? (
         ...
         <div className="BookDetail-container">
           {/* <Carousel
             ...
             indicators={false}
             style={{ zIndex: "1", padding: "0vw 5vw" }}
           > */}
                     ...
                     <div className="col-md-4">
                       <ListGroup>
                         <img
                           alt=""
                           src={
                             "http://localhost:5000/books/" + bookResult.bookThumbnail
                           }
                           style={{ width: "100%" }}
                         />
                       </ListGroup>
                     ...
                     <div className="col-md-8">
                       <ListGroup horizontal>
                         <ListGroup.Item className="text-left border-0 bg-transparent">
                           ...
                           <small className="text-muted">{bookResult.author}</small>
                         </ListGroup.Item>
                       </ListGroup>
                       <ListGroup horizontal>
                       ...
                       <ListGroup horizontal>
                         <ListGroup.Item className="text-left border-0 bg-transparent">
                           ...
                           <small className="text-muted">{bookResult.pages}</small>
                         </ListGroup.Item>
                       </ListGroup>
                       <ListGroup horizontal>
                         <ListGroup.Item className="text-left border-0 bg-transparent">
                           ...
                           <small className="text-muted">{bookResult.isbn}</small>
                         </ListGroup.Item>
                       </ListGroup>
                       <ListGroup horizontal>
                         <ListGroup.Item className="text-left border-0 bg-transparent">
                   ...
                   <div className={loading ? "d-false" : "row"}>
                     <div className="col-sm-12 text-right">
                       <Link to="/cart" className={addCart ? "" : "d-none"}>
                         <button
                           onClick={() => addProductToCart(bookResult.id)}
                           className="btn globalButtonNoRound m-1"
                         >
                           Add To Cart
